...
?>
	...
	<div class="row col-lg-12 justify-content-end">
		...
		<form id="formNovo" name="formNovo" action="usuarioCad.php" method="post" class="form col-lg-3 col-sm-10">
			...
			<button type="button" class="btn btn-dark" onClick="formNovo.submit();"><?php echo $lng['novcadastro'];?></button>
		</form>
		...
		<table id="dados" class="table table-bordered table-hover col-lg-10 col-sm-12" align="center" border=1>
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						<?php 
							if( $linha->usutipo == 'M' ) { echo $lng['master']; } 
							elseif( $linha->usutipo == 'A' ) { echo $lng['admin']; }
							elseif( $linha->usutipo == 'O' ) { echo $lng['operador']; }
						?>
					</td>
